...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { 
    ...
    [1] = LAYOUT_ansi_split_space( /* left space-bar */
        KC_GRV,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL, _______,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME,   KC_UP,  KC_END, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
        ...
        _______, _______, _______,                   XXXXXXX,          XXXXXXX,                   _______, _______, _______, _______, _______
    ),
    [2] = LAYOUT_ansi_split_space( /* FN */
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  _______,
    ...
    [3] = LAYOUT_ansi_split_space( /* numpad */
