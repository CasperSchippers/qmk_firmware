...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_RCTL] = ACTION_TAP_DANCE_DOUBLE(KC_RCTL, KC_RALT),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_LWIN,  KC_LALT,           MO(FN1),          MO(FN2),     MO(FN1),       KC_SPC,         TD(TD_RCTL),           KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [FN1] = LAYOUT_69_ansi(
        ...
        _______,           XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, KC_BSPC,XXXXXXX,C(KC_LBRC),C(KC_RBRC),XXXXXXX,  _______, KC_PGUP,
